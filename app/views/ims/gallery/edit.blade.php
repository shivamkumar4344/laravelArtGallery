...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-6 col-md-offset-1 main">
        <h1 class="page-header"><span class="glyphicon glyphicon-pencil"></span> Select an item for
            position {{$getId->id}}</h1>
        ...
        {{ Form::model($getId, ['method' => 'PUT', 'route' => ['ims.gallery.update', $getId->id]]) }}
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="radio" name="radio" Input::old('radio'), value="{{$art->id}}">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
